...
export const hasakProperties = {
    ...
    "KYRP_MIX_USB_L0": {nrpn: "110", type: "par", title: "i2s_in left to usb_out left", range: "-128 24", unit: "dB/4", property: "outUSB0Left"},
    "KYRP_MIX_USB_L1": {nrpn: "111", type: "par", title: "sidetone left to usb_out left", range: "-128 24", unit: "dB/4", property: "outUSB1Left"},
    "KYRP_MIX_USB_L2": {nrpn: "112", type: "par", title: "IQ left to usb_out left", range: "-128 24", unit: "dB/4", property: "outUSB2Left"},
    "KYRP_MIX_USB_L3": {nrpn: "113", type: "par", title: "usb_in left to usb_out left", range: "-128 24", unit: "dB/4", property: "outUSB3Left"},
    "KYRP_MIX_USB_R0": {nrpn: "114", type: "par", title: "i2s_in right to usb_out right", range: "-128 24", unit: "dB/4", property: "outUSB0Right"},
    "KYRP_MIX_USB_R1": {nrpn: "115", type: "par", title: "sidetone right to usb_out right", range: "-128 24", unit: "dB/4", property: "outUSB1Right"},
    "KYRP_MIX_USB_R2": {nrpn: "116", type: "par", title: "IQ right to usb_out right", range: "-128 24", unit: "dB/4", property: "outUSB2Right"},
    "KYRP_MIX_USB_R3": {nrpn: "117", type: "par", title: "usb_in right to usb_out right", range: "-128 24", unit: "dB/4", property: "outUSB3Right"},
    "KYRP_MIX_I2S_L0": {nrpn: "118", type: "par", title: "usb_in left to i2s_out left", range: "-128 24", unit: "dB/4", property: "outI2S0Left"},
    "KYRP_MIX_I2S_L1": {nrpn: "119", type: "par", title: "sidetone left to i2s_out left", range: "-128 24", unit: "dB/4", property: "outI2S1Left"},
    "KYRP_MIX_I2S_L2": {nrpn: "120", type: "par", title: "IQ left to i2s_out left", range: "-128 24", unit: "dB/4", property: "outI2S2Left"},
    "KYRP_MIX_I2S_L3": {nrpn: "121", type: "par", title: "i2s_in right to i2s_out right", range: "-128 24", unit: "dB/4", property: "outI2S3Left"},
    "KYRP_MIX_I2S_R0": {nrpn: "122", type: "par", title: "usb_in right to i2s_out right", range: "-128 24", unit: "dB/4", property: "outI2S0Right"},
    "KYRP_MIX_I2S_R1": {nrpn: "123", type: "par", title: "sidetone right to i2s_out right", range: "-128 24", unit: "dB/4", property: "outI2S1Right"},
    "KYRP_MIX_I2S_R2": {nrpn: "124", type: "par", title: "IQ right to i2s_out right", range: "-128 24", unit: "dB/4", property: "outI2S2Right"},
    "KYRP_MIX_I2S_R3": {nrpn: "125", type: "par", title: "i2s_in right to i2s_out right", range: "-128 24", unit: "dB/4", property: "outI2S3Right"},
    "KYRP_MIX_HDW_L0": {nrpn: "126", type: "par", title: "usb_in left to hdw_out left", range: "-128 24", unit: "dB/4", property: "outHDW0Left"},
    "KYRP_MIX_HDW_L1": {nrpn: "127", type: "par", title: "sidetone left to hdw_out left", range: "-128 24", unit: "dB/4", property: "outHDW1Left"},
    "KYRP_MIX_HDW_L2": {nrpn: "128", type: "par", title: "IQ left to hdw_out left", range: "-128 24", unit: "dB/4", property: "outHDW2Left"},
    "KYRP_MIX_HDW_L3": {nrpn: "129", type: "par", title: "i2s_in left to hdw_out left", range: "-128 24", unit: "dB/4", property: "outHDW3Left"},
    "KYRP_MIX_HDW_R0": {nrpn: "130", type: "par", title: "usb_in right to hdw_out right", range: "-128 24", unit: "dB/4", property: "outHDW0Right"},
    "KYRP_MIX_HDW_R1": {nrpn: "131", type: "par", title: "sidetone right to hdw_out right", range: "-128 24", unit: "dB/4", property: "outHDW1Right"},
    "KYRP_MIX_HDW_R2": {nrpn: "132", type: "par", title: "IQ right to hdw_out right", range: "-128 24", unit: "dB/4", property: "outHDW2Right"},
    "KYRP_MIX_HDW_R3": {nrpn: "133", type: "par", title: "i2s_in right to hdw_out right", range: "-128 24", unit: "dB/4", property: "outHDW3Right"},
    ...
    "KYRP_XFIRST": {nrpn: "1000", type: "rel", title: "base of extended nrpn block"},
    "KYRP_XKEYER": {nrpn: "1000", type: "rel", title: "base of extended keyer block"},
    "KYRP_XKEYER_LAST": {nrpn: "1006", type: "rel", title: "one past end of extended keyer block"},
    "KYRP_XVOX_OFFSET": {nrpn: "6", type: "rel", title: "size of extended keyer parameter block"},
    "KYRP_XVOX_NONE": {nrpn: "1000", type: "rel", title: "base of default keyer parameters"},
    "KYRP_XVOX_TUNE": {nrpn: "1006", type: "rel", title: "base of tune keyer parameters"},
    "KYRP_XVOX_S_KEY": {nrpn: "1012", type: "rel", title: "base of straight key parameters"},
    "KYRP_XVOX_PAD": {nrpn: "1018", type: "rel", title: "base of paddle keyer parameters"},
    "KYRP_XVOX_WINK": {nrpn: "1024", type: "rel", title: "base of text from winkey parameters"},
    "KYRP_XVOX_KYR": {nrpn: "1030", type: "rel", title: "base of text from hasak parameters"},
    "KYRP_XVOX_BUT": {nrpn: "1036", type: "rel", title: "base of headset button keyer parameters"},
    "KYRP_XLAST": {nrpn: "1042", type: "rel", title: "end+1 of extended keyer block"},
    ...
    outUSB0Left: "KYRP_MIX_USB_L0",
    outUSB1Left: "KYRP_MIX_USB_L1",
    outUSB2Left: "KYRP_MIX_USB_L2",
    outUSB3Left: "KYRP_MIX_USB_L3",
    outUSB0Right: "KYRP_MIX_USB_R0",
    outUSB1Right: "KYRP_MIX_USB_R1",
    outUSB2Right: "KYRP_MIX_USB_R2",
    outUSB3Right: "KYRP_MIX_USB_R3",
    outI2S0Left: "KYRP_MIX_I2S_L0",
    outI2S1Left: "KYRP_MIX_I2S_L1",
    outI2S2Left: "KYRP_MIX_I2S_L2",
    outI2S3Left: "KYRP_MIX_I2S_L3",
    outI2S0Right: "KYRP_MIX_I2S_R0",
    outI2S1Right: "KYRP_MIX_I2S_R1",
    outI2S2Right: "KYRP_MIX_I2S_R2",
    outI2S3Right: "KYRP_MIX_I2S_R3",
    outHDW0Left: "KYRP_MIX_HDW_L0",
    outHDW1Left: "KYRP_MIX_HDW_L1",
    outHDW2Left: "KYRP_MIX_HDW_L2",
    outHDW3Left: "KYRP_MIX_HDW_L3",
    outHDW0Right: "KYRP_MIX_HDW_R0",
    outHDW1Right: "KYRP_MIX_HDW_R1",
    outHDW2Right: "KYRP_MIX_HDW_R2",
    outHDW3Right: "KYRP_MIX_HDW_R3",
    keyerTone: "KYRP_TONE",
