...
export const hasakProperties = {
    ...
    "KYRP_CHAN_CC": {nrpn: 34, type: "par", title: "midi channel for sending controls", unit: "", range: "0 16", property: "channelCC"},
    "KYRP_CHAN_NOTE": {nrpn: 35, type: "par", title: "midi channel for sending input notes", unit: "", range: "0 16", property: "channelNote"},
    "KYRV_CHAN_INVALID": {nrpn: 0, type: "val", title: "invalid channel, used to disable midi channel"},
    "KYRP_NOTE": {nrpn: 36, type: "rel", title: "base of midi notes"},
    "KYRP_NOTE_L_PAD": {nrpn: 36, type: "par", title: "note for left paddle switch input", unit: "", range: "0 128", property: "noteLeftPaddle"},
    "KYRP_NOTE_R_PAD": {nrpn: 37, type: "par", title: "note for right paddle switch input", unit: "", range: "0 128", property: "noteRightPaddle"},
    "KYRP_NOTE_S_KEY": {nrpn: 38, type: "par", title: "note for straight key switch input", unit: "", range: "0 128", property: "noteStraightKey"},
    "KYRP_NOTE_EXT_PTT": {nrpn: 39, type: "par", title: "note for external ptt switch input", unit: "", range: "0 128", property: "noteExternalPTT"},
    "KYRP_NOTE_KEY_OUT": {nrpn: 40, type: "par", title: "note for key/ptt key output", unit: "", range: "0 128", property: "noteKeyOut"},
    "KYRP_NOTE_PTT_OUT": {nrpn: 41, type: "par", title: "note for key/ptt ptt output", unit: "", range: "0 128", property: "notePTTOut"},
    "KYRP_NOTE_TUNE": {nrpn: 42, type: "par", title: "note to key tune signal", unit: "", range: "0 128", property: "noteTune"},
    "KYRV_NOTE_INVALID": {nrpn: 128, type: "val", title: "invalid note, used to disable midi events"},
    "KYRP_PINS": {nrpn: 43, type: "rel", title: "base of hardware pin assignments"},
    "KYRP_ADC0_CONTROL": {nrpn: 43, type: "par", title: "property for adc0 = A0", unit: "", values: "KYRV_ADC_*", property: "adc0Control", valuesProperty: "adcControls"},
    ...
    "KYRP_ADC1_CONTROL": {nrpn: 44, type: "par", title: "property for adc1 = A1 (master volume on the CWKeyer)", unit: "", values: "KYRV_ADC_*", property: "adc1Control", valuesProperty: "adcControls"},
    "KYRP_ADC2_CONTROL": {nrpn: 45, type: "par", title: "property for adc2 = A2 (sidetone volume on the CWKeyer)", unit: "", values: "KYRV_ADC_*", property: "adc2Control", valuesProperty: "adcControls"},
    "KYRP_ADC3_CONTROL": {nrpn: 46, type: "par", title: "property for adc3 = A3 (sidetone frequency on the CWKeyer", unit: "", values: "KYRV_ADC_*", property: "adc4Control", valuesProperty: "adcControls"},
    "KYRP_ADC4_CONTROL": {nrpn: 47, type: "par", title: "property for adc4 = A8 (speed on the CWKeyer)", unit: "", values: "KYRV_ADC_*", property: "adc3Control", valuesProperty: "adcControls"},
    "KYRP_ADC_ENABLE": {nrpn: 48, type: "par", title: "enable adc channels", label: "ADCEn", range: "0 1", property: "adcEnable"},
    "KYRP_MORSE": {nrpn: 49, type: "rel", title: "morse code table base"},
    "KYRP_MIXER": {nrpn: 113, type: "rel", title: "base of output mixer block"},
    "KYRP_KEYER": {nrpn: 137, type: "rel", title: "base of vox specialized keyer parameters"},
    "KYRP_TONE": {nrpn: 137, type: "par", title: "sidetone and IQ oscillator frequency", range: "0 16383", unit: "Hz/10", property: "keyerTone"},
    "KYRP_LEVEL": {nrpn: 138, type: "par", title: "sidetone level", range: "-128 24", default: "0", unit: "dB/10", property: "keyerLevel"},
    "KYRP_SPEED": {nrpn: 139, type: "par", title: "keyer speed control", range: "0 16384", unit: "WPM", property: "keyerSpeed"},
    "KYRP_WEIGHT": {nrpn: 140, type: "par", title: "keyer mark/space weight", range: "25 75", unit: "%", default: "50", property: "keyerWeight"},
    "KYRP_RATIO": {nrpn: 141, type: "par", title: "keyer dit/dah ratio", range: "25 75", unit: "%", default: "50", property: "keyerRatio"},
    "KYRP_FARNS": {nrpn: 142, type: "par", title: "Farnsworth keying speed", range: "0 127", default: "0", unit: "WPM", property: "keyerFarnsworth"},
    "KYRP_COMP": {nrpn: 143, type: "par", title: "keyer compensation", range: "-8192 8191", default: "0", unit: "sample", property: "keyerCompensation"},
    "KYRP_SPEED_FRAC": {nrpn: 144, type: "par", title: "keyer speed fraction", range: "0 127", default: "0", unit: "WPM/128", property: "keyerSpeedFraction"},
    "KYRP_KEYER_LAST": {nrpn: 145, type: "rel", title: "end of keyer block"},
    "KYRP_VOX_OFFSET": {nrpn: 8, type: "rel", title: "size of keyer parameter block"},
    "KYRP_VOX_NONE": {nrpn: 137, type: "rel", title: "base of default keyer parameters"},
    "KYRP_VOX_TUNE": {nrpn: 145, type: "rel", title: "base of tune keyer parameters"},
    "KYRP_VOX_S_KEY": {nrpn: 153, type: "rel", title: "base of straight key parameters"},
    "KYRP_VOX_PAD": {nrpn: 161, type: "rel", title: "base of paddle keyer parameters"},
    "KYRP_VOX_WINK": {nrpn: 169, type: "rel", title: "base of text from winkey parameters"},
    "KYRP_VOX_KYR": {nrpn: 177, type: "rel", title: "base of text from hasak parameters"},
    "KYRP_VOX_BUT": {nrpn: 185, type: "rel", title: "base of headset button keyer parameters"},
    ...
    "KYRV_ADC_SPEED": {nrpn: 139, type: "val", label: "Speed", title: "pot controls keyer speed", property: "adcControls"},
    "KYRV_ADC_LEVEL": {nrpn: 138, type: "val", label: "Level", title: "pot controls sidetone level", property: "adcControls"},
    "KYRV_ADC_TONE": {nrpn: 137, type: "val", label: "Tone", title: "pot controls sidetone pitch", property: "adcControls"},
    "KYRP_LAST": {nrpn: 193, type: "rel", title: "one past end of stored keyer parameters"},
    ...
    37: "KYRP_NOTE_R_PAD",
    38: "KYRP_NOTE_S_KEY",
    39: "KYRP_NOTE_EXT_PTT",
    40: "KYRP_NOTE_KEY_OUT",
    41: "KYRP_NOTE_PTT_OUT",
    42: "KYRP_NOTE_TUNE",
    43: "KYRP_ADC0_CONTROL",
    44: "KYRP_ADC1_CONTROL",
    45: "KYRP_ADC2_CONTROL",
    46: "KYRP_ADC3_CONTROL",
    47: "KYRP_ADC4_CONTROL",
    48: "KYRP_ADC_ENABLE",
    137: "KYRP_TONE",
    138: "KYRP_LEVEL",
    139: "KYRP_SPEED",
